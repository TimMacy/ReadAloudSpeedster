...
## 📜 Changelog
- **6.0.1**: adjustments for DOM changes
...
- **5.33.1**: adjustments for DOM changes
- **5.33**: bug fixes and adjustments for DOM changes (new slider )
- **5.32.6**: adjustments for DOM changes (playback speed)
- **5.32.5**: adjustments for DOM changes
- **5.32.4**: adjustments for DOM changes
- **5.32.3**: adjustments for DOM changes
- **5.32.2**: adjustments for DOM changes
- **5.32.1**: adjustments for DOM changes
- **5.32**: adjustments for DOM changes (ChatGPT Work)
- **5.31.1**: adjustments for DOM changes and improvements; new feature: "Auto-Close Projects on Page Load"
- **5.30.1**: adjustments for DOM changes and improvements
- **5.27.6**: adjustments for DOM changes
- **5.27.5**: adjustments for DOM changes
...
- **5.21**: new feature: "Allow for Resizing the Text Field Vertically"
- **5.20**: adjustments for DOM changes and added support for the Library
- **5.19.4**: adjustments for DOM changes
- **5.19.1**: adjustments for DOM changes and improvements for "Message Navigation Arrows"
- **5.18**: adjustments for DOM changes (removed feature "Use 'Extended Thinking' by Default" and "Auto" button)
- **5.17.5**: adjustments for DOM changes
- **5.17.1**: adjustments for DOM changes
- **5.17**: adjustments to the "Quick Model Selector Buttons" to work regardless of GPT version
- **5.16.1**: adjustments for DOM changes ('Message Navigation Arrows' now re-queries chat container when disconnected)
- **5.16**: adjustments for DOM changes and the upcoming GPT-4o retirement
- **5.15.8**: bug fixes
- **5.15.7**: adjustments for the latest DOM changes
- **5.15.4**: bug fixes
- **5.15.2**: bug fixes
- **5.15.1**: adjustments for the latest DOM changes
- **5.15**: adjustments for ChatGPT Apps
